...
정보의 수명에 따라 메모를 **FIRE / ICE / TRASH**로 구분하여 관리하는 모바일 메모 애플리케이션 **비움(Bium)**의 Frontend Repository입니다.
...
메모를 **FIRE / ICE / TRASH**로 구분하고, 정보가 필요한 기간과 보관 목적에 따라 메모의 상태를 관리할 수 있도록 구성했습니다.
...
TRASH로 이동한 메모는 **24시간이 지나면 자동으로 영구 삭제됩니다.**
