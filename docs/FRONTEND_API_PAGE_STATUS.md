...
| 페이지       | 상태 | 7/23 연결                           | 남은 확인                |
| ------------ | ---- | ----------------------------------- | ------------------------ |
| Home         | 연결 | 목록·상세·상태·PIN·휴지통·만료 표시 | PIN value                |
...
| Notification | 부분 | 목록·읽음·삭제, 4개 타입 이동       | TEAM_TODO                |
...
| ProjectTodo       | 연결 | 목록·전체 수정·체크·삭제             | 실서버         |
...
| DeviceManagement | 부분 | 현재 기기·전체 로그아웃                     | 기기 목록 GET  |
