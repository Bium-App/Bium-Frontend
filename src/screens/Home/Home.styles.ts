...
import type {HomeMemoItem, MemoSection} from '../../hooks/useHome';

const TypedSectionList = SectionList<HomeMemoItem, MemoSection>;
...
export const ListContainer = styled(TypedSectionList).attrs({
