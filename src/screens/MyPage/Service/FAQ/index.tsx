...
const FAQ_DATA = [
  ...
  },
  {
    ...
    steps: [
      '작성 화면에서 저장 버튼을 누르면 서버에 저장',
      '현재 버전은 저장 시 인터넷 연결이 필요하며 오프라인 저장은 지원하지 않음',
    ],
  },
  {
    id: 6,
    ...
    steps: [
      '삭제된 메모는 먼저 "휴지통"으로 이동하여 24시간 동안 보관',
      '휴지통에서 수동으로 영구 삭제하거나 24시간이 지나면 완전 삭제됨',
      '중요한 메모는 삭제 전 다시 한번 확인해 주세요.',
    ],
  },
];

export default function FAQ({navigation}: RootScreenProps<'FAQ'>) {
