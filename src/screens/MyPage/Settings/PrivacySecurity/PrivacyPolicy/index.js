  ...
  return (
    <Container>
      ...
      <ScrollContainer showsVerticalScrollIndicator={false}>
        ...
        {/* 💡 최상단 전체 안내문 (모바일 화면 길이에 맞춰 자연스럽게 줄바꿈되도록 작성) */}
        <TopIntroText>
        ...
        <SectionContainer>
          ...
          <PolicyCard>
            <IconWrapper>
              <IcPrivacyCollection width={80} height={80} />
            </IconWrapper>
        ...
        <SectionContainer>
          ...
          <PolicyCard>
            <IconWrapper>
              <IcPrivacySharing width={80} height={80} />
            </IconWrapper>
        ...
        <SectionContainer>
          ...
          <PolicyCard>
            <IconWrapper>
              <IcPrivacyDestruction width={80} height={80} />
            </IconWrapper>
        ...
        <SectionContainer>
          ...
          <PolicyCard>
            <IconWrapper>
              <IcPrivacyRights width={80} height={80} />
            </IconWrapper>
            ...
            <BulletListContainer>
              ...
              <BulletRow>
                <BulletDot>-</BulletDot>
                <BulletText>개인정보 침해 불편 및 신고</BulletText>
              </BulletRow>
            </BulletListContainer>
          </PolicyCard>
        </SectionContainer>
