...
export const PopupOptionBtn = styled.TouchableOpacity<{isLast?: boolean}>`
  flex-direction: row; 
  align-items: center; 
  padding: 10px 16px; 
  border-bottom-width: ${({ isLast }) => (isLast ? 0 : 1)}px; 
...
export const PopupOptionText = styled.Text<{isDanger?: boolean}>`
  font-size: 14px; 
  font-weight: 400; 
  margin-left: 10px; 
...
export const ActionModalSaveText = styled.Text<{isDanger?: boolean}>`
  font-size: 15px;
  font-weight: 700;
...
export const ActionModalLabel = styled.Text<{isFirst: boolean}>`
  font-size: 14px;
  font-weight: 600;
  color: #000000;
  margin-bottom: 8px; 
